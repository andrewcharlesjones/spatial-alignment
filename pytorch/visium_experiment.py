...
if __name__ == "__main__":
	...
	Y1_expression = (
		Y1_expression - Y1_expression.mean(0)
	) / Y1_expression.std(0)
	Y2_expression = (
		Y2_expression - Y2_expression.mean(0)
	) / Y2_expression.std(0)
	...
	X1_observed = X1 @ (np.eye(2) + np.random.normal(0, 0.05, size=(2, 2))) #+ np.random.normal(scale=0.25, size=X_orig_single.shape)
	X2_observed = X2 @ (np.eye(2) + np.random.normal(0, 0.05, size=(2, 2))) #+ np.random.normal(scale=0.25, size=X_orig_single.shape)
